...
export function Hero({ trip }: { trip: Trip }) {
  ...
  return (
    <section className="relative isolate w-full overflow-hidden bg-mm-black text-mm-bone md:min-h-[105svh]">
      {/* Background media */}
      {trip.heroVideoUrl ? (
        <video
      ...
      {/* Starburst device */}
      <div className="absolute right-6 top-20 z-20 md:hidden">
      ...
      <div className="relative z-10 flex w-full flex-col px-4 pb-14 pt-20 md:hidden">
      ...
      <div className="relative z-10 mx-auto hidden min-h-[105svh] max-w-7xl grid-rows-[6rem_1fr_auto] px-12 pb-10 pt-0 md:grid">
        <div />
