  ...
  return (
    <section className="relative bg-mm-black px-5 py-16 text-mm-bone md:px-8 md:py-24">
      <div className="mx-auto max-w-6xl">
        <span className="font-sticker text-[11px] tracking-[0.24em] text-mm-bone/70">THE CREW</span>
        <h2 className="mt-3 font-display text-[2.5rem] leading-[0.92] md:text-6xl">
          WHO'S COMING<br /><span className="text-mm-lime">YOUR NEW CREW.</span>
        </h2>
        ...
        <div className="mt-10 grid gap-6 md:mt-12 md:grid-cols-2 lg:grid-cols-4">
          {REVIEWS.map((r) => (
            <a
              ...
              className="group block border-[3px] border-mm-bone bg-mm-paper p-5 shadow-mm transition-transform hover:-translate-y-1"
            >
